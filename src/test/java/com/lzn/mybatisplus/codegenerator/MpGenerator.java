...
public class MpGenerator {
    ...
    static String javaSrcDir = "E:/githubPro/code-generator/src/main/java";
    static String resourceDir = "E:/githubPro/code-generator/src/main/resources";
    //第二步修改 pageRootDir 修改成你要开发的模块的名称 存放ftl文件的文件夹的根路径
    static String pageRootDir ="E:/githubPro/code-generator/src/main/resources/templates/pages/";
...
//         gc.setServiceImplName("%sService");
        ...
        dsc.setUrl("jdbc:mysql://192.168.202.128:3306/sfddj?useSSL=false");
